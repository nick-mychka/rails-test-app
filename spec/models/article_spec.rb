...
RSpec.describe Article, type: :model do
  describe '#validations' do
    ...
    it "should validate the presence of the tittle" do
      article = build :article, tittle: ''
      expect(article).not_to be_valid
      expect(article.errors.messages[:tittle]).to include('can\'t be blank')
    end
    ...
    it "should check the uniqueness of the slug" do
